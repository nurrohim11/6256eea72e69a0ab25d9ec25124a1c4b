...
<?php 
	$k = $this->db->query("
		SELECT a.*,b.kode as kode_klasifikasi,c.kode as kode_sub_klasifikasi, d.kode as kode_kualifikasi, e.permohonan, (a.biaya+a.biaya_lpjkp+a.biaya_lpjkn) as t_biaya, b.deskripsi_lengkap
	...
	<table style="width: 100%" cellpadding="7" cellspacing="0" border="0">
		...
		<tr>
			<td style="text-align: center;padding-top: 4px"><b style="font-size: 17px; text-align: center; text-decoration: underline;">REGISTRASI BADAN USAHA</b></td>
		</tr>
		<tr style="margin-top: 3px">
	...
	<table style="width: 100%" border="0" cellpadding="10">
		...
		<tr>
			<td class="td-cellpadding" style="width: 40%">
				<b>Nama Badan Usaha</b>
			</td>
			<td class="td-cellpadding" style="width: 1px">
				<b>:</b>
			</td>
			<td class="td-cellpadding">
				<b><?php echo $p->nama_bu ?></b>
			</td>
		</tr>
		<tr>
			<td class="td-cellpadding" style="width: 40%">
				<b>Nama Penganggung Jawab</b>
			</td>
			<td class="td-cellpadding" style="width: 1px">
				<b>:</b>
			</td>
			<td class="td-cellpadding">
				<b><?php echo $p->penanggung_jawab ?></b>
			</td>
		</tr>
		<tr>
			<td class="td-cellpadding" style="width: 40%">
	...
	<table class="tb-center" style="width: 100%; margin-top: 2px; margin-bottom: 2px" border="1" cellspacing="0" >
		<tr>
			...
			<th style="text-align: center; width: 15%; padding: 4px">Kualifikasi</th>
			<th style="text-align: center; width: 15%; padding: 4px">Kode</th>
			<th style="text-align: center; width: 20%; padding: 4px">Klasifikasi</th>
			<th style="text-align: center; width: 20%; padding: 4px">Assosiasi</th>
			<th style="text-align: center; width: 25%; padding: 4px">Keterangan</th>
		</tr>
		<?php
		$no=0;
		foreach($k as $row){
		...
		<tr>
			...
			<td style="padding: 4px; text-align: center;"><?php echo ($p->nama) ? $p->nama : '' ?></td>
	...
	<table style="width: 100%; margin-top: 2px; margin-bottom: 2px" border="1" cellspacing="0" >
		...
		<?php
		$query = $this->db->query("
			SELECT a.*,b.nama, c.jabatan FROM history_approval_sbu a 
			join tb_user b 
				on b.id = a.id_user
		...
		<tr>
			...
			<!-- <td style="padding: 4px; text-align: center;"><img src="https://badoystudio.com/wp-content/uploads/2018/11/apa-itu-programmer-750x410.jpeg"></td> -->
			<?php 
			$ttd ='';
			if($r->ttd != ''){

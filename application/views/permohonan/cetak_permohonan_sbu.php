...
<body style="padding: 50px">
	...
	<table style="width: 100%" cellpadding="7" cellspacing="0" border="1">
		<tr style="background: #ffff24">
			...
			<td style="width: 21%;padding-left: 4px; padding-right: 4px;">NPWP</td>
			<td style="width: 15%;padding-left: 4px; padding-right: 4px; ">Nama</td>
			<td style="width: 12%;padding-left: 4px; padding-right: 4px; ">Kota</td>
			<td style="width: 20%;padding-left: 4px; padding-right: 4px; ">Alamat</td>
			<td style="width: 15%;padding-left: 4px; padding-right: 4px; ">Jenis KBLI</td>
		...
		foreach($bu as $row){
			...
			?>
		<tr>
			<td  style="width: 4%;padding-left: 4px; padding-right: 4px; padding-top: 4px;"><?php echo $no ?></td>
			<td style="width: 21%;padding-left: 4px; padding-right: 4px;"><?php echo $row['npwp'] ?></td>
			<td style="width: 15%;padding-left: 4px; padding-right: 4px; "><?php echo $row['nama'] ?></td>
			<td style="width: 12%;padding-left: 4px; padding-right: 4px; "><?php echo ucwords(strtolower($row['kota'])) ?></td>
			<td  style="width: 20%;padding-left: 4px; padding-right: 4px; padding-bottom: 4px"><?php echo $row['alamat'] ?></td>
			<td  style="width: 15%;padding-left: 4px; padding-right: 4px; "><?php echo $row['kbli'] ?></td>
			<td  style="width: 15%;padding-left: 4px; padding-right: 4px; "><?php echo ucwords(ucfirst(strtolower($row['asosiasi']))) ?></td>
		</tr>
		<tr style="">
			<td  style="width: 4%;padding-left: 4px;padding-right: 4px; padding-top: 4px;padding-bottom: 4px">&nbsp;</td>
			<td style="width: 21%;padding-left: 4px; padding-right: 4px; padding-top: 4px; padding-bottom: 4px;background: #ffff24">Klasifikasi</td>
			<!-- <td style="width: 15%;padding-left: 4px; padding-right: 4px;  padding-top: 4px; padding-bottom: 4px;background: #ffff24">Sub Klasifikasi</td> -->
			...
			<td  style="width: 20%;padding-left: 4px; padding-right: 4px; padding-top: 4px; padding-bottom: 4px;background: #ffff24">Permohonan</td>
		...
		foreach($detail as $ro){ 
			...
			<tr style="">
				<td  style="width: 4%;padding-left: 4px;padding-right: 4px; padding-top: 4px;padding-bottom: 4px">&nbsp;</td>
				<td style="width: 21%;padding-left: 4px; padding-right: 4px; padding-top: 4px; padding-bottom: 4px;"><?php echo $ro->kode_klasifikasi ?></td>
				...
				<td  style="width: 20%;padding-left: 4px; padding-right: 4px; padding-top: 4px; padding-bottom: 4px;"><?php echo $ro->permohonan ?></td>
		...
		<tr style="">
			...
			<td  style="width: 15%;padding-left: 4px; padding-right: 4px; padding-top: 4px; padding-bottom: 4px;background: #ffff24">&nbsp;</td>
			<td  style="width: 15%;padding-left: 4px; padding-right: 4px;  padding-top: 4px; padding-bottom: 4px;background: #ffff24">Biaya LPJKP</td>
			<td  style="width: 15%;padding-left: 4px; padding-right: 4px;  padding-top: 4px; padding-bottom: 4px;background: #ffff24">Biaya LPJKN</td>
		</tr>
		<?php 
		...
		<tr style="">
			...
			<td  style="width: 20%;padding-left: 4px; padding-right: 4px; padding-top: 4px; padding-bottom: 4px;">&nbsp;</td>
		...
		<tr >
			<td style="width: 4%;padding-left: 4px; padding-right: 4px; padding-top: 4px;padding-bottom: 4px"></td>
			<td style="width: 21%;padding-left: 4px; padding-right: 4px;"></td>
			<td style="width: 15%;padding-left: 4px; padding-right: 4px; "></td>
			<td style="width: 12%;padding-left: 4px; padding-right: 4px; "></td>
			<td style="width: 20%;padding-left: 4px; padding-right: 4px;padding-top: 4px;padding-bottom: 4px "><b>Jumlah</b></td>
		...
		<tr style="background: #ffff24">
			...
			<td style="width: 15%;padding-left: 4px; padding-right: 4px; "></td>
			<td style="width: 12%;padding-left: 4px; padding-right: 4px; "></td>
			<td style="width: 20%;padding-left: 4px; padding-right: 4px;padding-top: 4px;padding-bottom: 4px "><b>Total Biaya</b></td>
			<td colspan="2" style="text-align: center; width: 16%;padding-left: 4px; padding-right: 4px; "><b><?php echo money($lpjkp+$lpjkn) ?></b></td>
		</tr>
	</table>
	<table style="width: 100%" cellpadding="7" cellspacing="0" border="0">

            ...
            <div class="col-md-12">
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form id="form_skt">
                        	<input type="hidden" name="token" id="token" value="0.5147942568094299">
                            <div class="form-body">
                                ...
                                <!-- <div class="form-group"> -->
				                    <div class="row">
				                        <div class="col-md-12">
	                                    <table class="table table-striped table-bordered table-hover" id="tbl_skt">
	                                        <thead>
	                                            <tr>
	                                                <th> # </th>
	                                                <th> NIK </th>
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <button type="button" id="btn_cancel_skt" class="btn default">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        	...
        	<form id="form_personal_skt">
	            ...
	            <div class="modal-body">
                	...
                	<div class="form-group" style="text-align: right;">
	                	<button type="button" class="btn default" id="btn_add_skt"><i class="fa fa-plus"></i></button>
	                </div>
	                <div class="form-group">
	                	<table id="tbl_klasifikasi_skt" class="table table-bordered table-striped table-responsive">
	                		<thead>
		                		<tr>

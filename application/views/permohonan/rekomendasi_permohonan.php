    ...
    <div class="page-content">
        ...
        <div class="page-head">
            ...
            <div class="page-title">
                <h1>List Permohonan yang Belum di Rekomendasikan
                </h1>
            </div>
            <!-- END PAGE TITLE -->
        </div>
            	...
            	<div class="portlet box">
                    <div class="portlet-body flip-scroll">
	            		<div class="row" style="margin-bottom: 10px"> 
	            			<div class="col-md-4">
	            				<select id="assosiasi" class="form-group">
	            					<option></option>
	            			...
	            			<div class="col-md-4">
	            				<button class="btn btn-flat btn-info" type="button" id="btn_filter">Filter</button>
	            				<button class="btn btn-flat btn-default" type="button" id="btn_all">All</button>
	            			</div>
	            		</div>
                        <table class="table table-bordered table-striped table-condensed flip-content" id="tbl_rekomendasi_permohonan">
